...
public class AspectLogging {
  ...
  @Pointcut("execution(* Spring_Boot_Intro.services.jpa.JpaProductService.getAllActiveProducts(..))")
  ...
  @Pointcut("execution(* Spring_Boot_Intro.services.jpa.JpaProductService.restoreById(..))")
  public void restore() {}
  ...
  @Pointcut("execution(* Spring_Boot_Intro.services.jpa.JpaProductService.getActiveProductById(..))")
