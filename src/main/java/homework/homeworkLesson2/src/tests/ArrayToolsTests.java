...
class ArrayToolsTests {
  ...
  public void init() {
    ...
    this.incorrectArray2 = new int[]{-99, 7};
  }
  ...
  @Test
  public void FindSecondBiggestNumberInArrayReturnsCorrectValueReturnCorrectValueWithCorrectArray() {
    int expected = 101;
  ...
  @Test
  public void FindSecondBiggestNumberInArrayReturnsCorrectValueReturnCorrectValueWithIncorrectArray() {
    int expected = -99;
    int result = tools.FindSecondBiggestNumberInArray(incorrectArray2);
    assertEquals(expected, result);
  }

  @Test
  public void FindSecondLowestNumberInArrayReturnCorrectValueWithCorrectArray() {
    int expected = -9;
  ...
  @Test
  public void FindSecondLowestNumberInArrayReturnCorrectValueWithIncorrectArray() {
    int expected = 7;
    int result = tools.FindSecondLowestNumberInArray(incorrectArray2);
    assertEquals(expected, result);
  }
